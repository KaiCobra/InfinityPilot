...
data_root = "/media/avlab/f09873b9-7c6a-4146-acdb-7db847b573201/SynData/real_data/Total-text"
data_img_pth = osp.join(data_root, "images")
exsit = os.listdir('./generated_totaltext')
for img in sorted(os.listdir(data_img_pth)):
    if img in exsit: continue
    ...
    prompt = "Render the text \"" + "\" and \"".join(matches) + "\" in the following image: " + metadata['long_caption']
    print(prompt)
    # continue
    ...
    args.save_file = './generated_totaltext/' + img
