...
import torch
from CAR.conditions.util import resize_image, HWC3, load_image, nms, ckpt_path
...
def extract(type, image_path):
    ...
    if type == 'canny':
        ...
        from CAR.conditions.hed import HEDdetector
        ...
        from CAR.conditions.pidinet import apply_pidinet
