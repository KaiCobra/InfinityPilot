...
from infinity.dataset.build_v2 import build_t2i_dataset
...
def build_everything_from_args(args: arg_util.Args, saver):
    ...
    from trainer_v2 import InfinityTrainer
    # build trainer
...
def build_model_optimizer(args, vae_ckpt):
    ...
    from infinity.models.infinity_v2 import Infinity, MultipleLayers
